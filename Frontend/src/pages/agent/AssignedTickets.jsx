...
//             className="block bg-slate-800 p-5 rounded-xl"
//           >
          ...
          <div className="space-y-4">
            ...
            {filteredTickets.map(ticket => (
              ...
              <Link
                key={ticket._id}
                to={`/agent/tickets/${ticket._id}`}
                className="block bg-slate-800 border border-slate-700 rounded-2xl p-6 hover:border-violet-500 transition-all"
              >
