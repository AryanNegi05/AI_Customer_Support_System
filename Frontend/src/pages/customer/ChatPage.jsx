  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      role: 'bot',
      text: "Hi! I'm your AI support assistant. Describe your issue and I'll try to help."
    }
  ])
            ...
            >
              ...
              {msg.role === 'system' ? (
                ...
                <div className="w-full flex justify-center">
                  ...
                  <div className="bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 px-5 py-4 rounded-2xl text-sm whitespace-pre-line max-w-md text-center">
