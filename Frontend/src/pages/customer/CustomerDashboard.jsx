        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          {stats.map((s) => (
            ...
            <div
              ...
              className="backdrop-blur-sm bg-slate-800/40 border border-slate-700/50 rounded-2xl p-5"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-slate-400 text-sm mt-1">
              ...
              Talk to our AI assistant to get instant help
          ...
          >
            ...
            <span className="inline-block mt-3 text-emerald-400 text-sm group-hover:translate-x-1 transition-transform">
